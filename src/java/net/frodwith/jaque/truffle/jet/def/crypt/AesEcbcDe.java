...
import net.frodwith.jaque.truffle.jet.ops.crypt.AesEcbcDeNodeGen;

public final class AesEcbcDe extends Definition {
  @Override
  public ImplementationNode createNode(Context context, CallTarget fallback) {
    return new AesEcbNode(AesEcbcDeNodeGen.create());
  }
}
