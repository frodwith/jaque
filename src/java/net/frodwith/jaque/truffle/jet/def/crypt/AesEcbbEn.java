...
import net.frodwith.jaque.truffle.jet.ops.crypt.AesEcbbEnNodeGen;

public final class AesEcbbEn extends Definition {
  @Override
  public ImplementationNode createNode(Context context, CallTarget fallback) {
    return new AesEcbNode(AesEcbbEnNodeGen.create());
  }
}
