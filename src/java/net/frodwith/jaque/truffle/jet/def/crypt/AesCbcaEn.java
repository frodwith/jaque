...
import net.frodwith.jaque.truffle.jet.ops.crypt.AesCbcaEnNodeGen;

public final class AesCbcaEn extends Definition {
  @Override
  public ImplementationNode createNode(Context context, CallTarget fallback) {
    return new AesCbcNode(AesCbcaEnNodeGen.create());
  }
}
