...
public abstract class NockFormula extends Formula {
  ...
  {
    return callNode.call(new Object[] {getContext(frame), subject});
  }
    ...
    @Cached("create()") IndirectCallNode callNode) 
  {
    ...
    return callNode.call(target, new Object[] {getContext(frame), subject});
  }
  
  protected static CallTarget getTarget(Cell formula) {
    return Truffle.getRuntime().createCallTarget(new NockRootNode(Formula.fromNoun(formula)));
  }
